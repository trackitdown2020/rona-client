...
export const GoogleNewsListItem = () => {
  const example = {
    ...
    description:
      'The commander of a US aircraft carrier that has been hit by a major outbreak of coronavirus has been relieved of command for showing "poor judgment" days after writing a memo warning Navy leadership that decisive action was needed to save the lives of the shi…',
    url:
    ...
    content:
      'Washington (CNN)The commander of a US aircraft carrier that has been hit by a major outbreak of coronavirus has been relieved of command for showing "poor judgment" days after writing a memo warning Navy leadership that decisive action was needed to save the … [+6386 chars]'
  };
  return (
...
export const RedditListItem = () => {
  const example = {
    ...
    permalink:
      '/r/Coronavirus/comments/gmixss/chloroquine_is_a_potent_inhibitor_of_sars/'
  };
  return (
    <div style={{ width: '400px' }}>
      <Paper elevation={3}>
